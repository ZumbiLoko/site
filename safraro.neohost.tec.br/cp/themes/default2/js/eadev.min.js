...
$(document).ready(function(){$(".char-slide").slick({infinite:!0,slidesToShow:3,slidesToScroll:1,arrows:!0,autoplay:0}),$(".admin-options").on("click",function(o){o.preventDefault(),$(".sub-nav").toggle("slow")}),$(".audio-controls button").on("click",function(o){o.preventDefault();var e=document.getElementById("audio");e.paused?($(this).removeClass("fa-volume-off").addClass("fa-volume-up"),e.play()):($(this).removeClass("fa-volume-up").addClass("fa-volume-off"),e.pause())}),$(".players-online").countTo({speed:5e3}),$(".click-redirect").on("click",function(c){c.preventDefault();var i=$(this).data("href");window.location=i})});